...
log_file <- file.path(outdir, "panelA_diff_plots_noscale.log")
...
## MALE E33
png("panelA_diff_plots/netDiff_ME3_M06E33_vs_M12E33_noscale.png", width=WIDTH, height=HEIGHT, res=300)
plot_diff(cellchat.ME3, c(1,2))
dev.off(); cat("[SAVED] netDiff_ME3_M06E33_vs_M12E33_noscale.png\n")

png("panelA_diff_plots/netDiff_ME3_M12E33_vs_M18E33_noscale.png", width=WIDTH, height=HEIGHT, res=300)
plot_diff(cellchat.ME3, c(2,3))
dev.off(); cat("[SAVED] netDiff_ME3_M12E33_vs_M18E33_noscale.png\n")

png("panelA_diff_plots/netDiff_ME3_M06E33_vs_M18E33_noscale.png", width=WIDTH, height=HEIGHT, res=300)
plot_diff(cellchat.ME3, c(1,3))
dev.off(); cat("[SAVED] netDiff_ME3_M06E33_vs_M18E33_noscale.png\n")

## FEMALE E33
png("panelA_diff_plots/netDiff_FE3_F06E33_vs_F12E33_noscale.png", width=WIDTH, height=HEIGHT, res=300)
plot_diff(cellchat.FE3, c(1,2))
dev.off(); cat("[SAVED] netDiff_FE3_F06E33_vs_F12E33_noscale.png\n")

png("panelA_diff_plots/netDiff_FE3_F12E33_vs_F18E33_noscale.png", width=WIDTH, height=HEIGHT, res=300)
plot_diff(cellchat.FE3, c(2,3))
dev.off(); cat("[SAVED] netDiff_FE3_F12E33_vs_F18E33_noscale.png\n")

png("panelA_diff_plots/netDiff_FE3_F06E33_vs_F18E33_noscale.png", width=WIDTH, height=HEIGHT, res=300)
plot_diff(cellchat.FE3, c(1,3))
dev.off(); cat("[SAVED] netDiff_FE3_F06E33_vs_F18E33_noscale.png\n")

## MALE E44
png("panelA_diff_plots/netDiff_ME4_M06E44_vs_M12E44_noscale.png", width=WIDTH, height=HEIGHT, res=300)
plot_diff(cellchat.ME4, c(1,2))
dev.off(); cat("[SAVED] netDiff_ME4_M06E44_vs_M12E44_noscale.png\n")

png("panelA_diff_plots/netDiff_ME4_M12E44_vs_M18E44_noscale.png", width=WIDTH, height=HEIGHT, res=300)
plot_diff(cellchat.ME4, c(2,3))
dev.off(); cat("[SAVED] netDiff_ME4_M12E44_vs_M18E44_noscale.png\n")

png("panelA_diff_plots/netDiff_ME4_M06E44_vs_M18E44_noscale.png", width=WIDTH, height=HEIGHT, res=300)
plot_diff(cellchat.ME4, c(1,3))
dev.off(); cat("[SAVED] netDiff_ME4_M06E44_vs_M18E44_noscale.png\n")

## FEMALE E44
png("panelA_diff_plots/netDiff_FE4_F06E44_vs_F12E44_noscale.png", width=WIDTH, height=HEIGHT, res=300)
plot_diff(cellchat.FE4, c(1,2))
dev.off(); cat("[SAVED] netDiff_FE4_F06E44_vs_F12E44_noscale.png\n")

png("panelA_diff_plots/netDiff_FE4_F12E44_vs_F18E44_noscale.png", width=WIDTH, height=HEIGHT, res=300)
plot_diff(cellchat.FE4, c(2,3))
dev.off(); cat("[SAVED] netDiff_FE4_F12E44_vs_F18E44_noscale.png\n")

png("panelA_diff_plots/netDiff_FE4_F06E44_vs_F18E44_noscale.png", width=WIDTH, height=HEIGHT, res=300)
plot_diff(cellchat.FE4, c(1,3))
dev.off(); cat("[SAVED] netDiff_FE4_F06E44_vs_F18E44_noscale.png\n")
